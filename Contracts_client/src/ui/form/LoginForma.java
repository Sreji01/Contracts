...
public class LoginForma extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jPasswordFieldLozinka, javax.swing.GroupLayout.PREFERRED_SIZE, 131, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jTextFieldKorisnickoIme, javax.swing.GroupLayout.PREFERRED_SIZE, 131, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButtonUlogujSeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUlogujSeActionPerformed
        try {
            ...
            menadzer.setKorisnickoIme(jTextFieldKorisnickoIme.getText());
            menadzer.setLozinka(new String(jPasswordFieldLozinka.getPassword()));
            Kontroller.getInstance().ulogujSe(menadzer);
            JOptionPane.showMessageDialog(this, "Uspesno ste ulogovani!", "Obavestenje", JOptionPane.INFORMATION_MESSAGE);
            PocetnaForma pf = new PocetnaForma();
            pf.setUlogovaniMenadzer(menadzer);
            this.dispose();
            pf.setVisible(true);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this, ex.getMessage(), "Obavestenje", JOptionPane.ERROR_MESSAGE);
            if(ex.getMessage().equals("Pogresno korisnicko ime ili sifra!")){
                jTextFieldKorisnickoIme.setText("");
                jPasswordFieldLozinka.setText("");
            }
        }
